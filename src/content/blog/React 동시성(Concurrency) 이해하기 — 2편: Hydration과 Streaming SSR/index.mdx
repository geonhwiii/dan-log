...
summary: 'React API에 대해 간단히 알아보고, 1편에 이어 Streaming SSR과 Hydration에 대해 깊게 알아봅니다.'
date: '04 12 2026'
draft: false
...
`Hydration`은 서버에서 **미리 렌더링된 HTML에 React가 "붙어서" 이벤트 핸들러를 연결**하고 DOM 관리권을 가져오는 과정입니다.
단순히 DOM을 새로 그리는 게 아니라, 기존 HTML 구조를 재활용하면서 인터랙티브하게 만드는 것이 핵심입니다.
